...
`@modelcontextprotocol/conformance@0.2.0-alpha.8 server --suite all
...
`@modelcontextprotocol/conformance@0.2.0-alpha.8` one by one with `--suite all`
...
As of `@modelcontextprotocol/conformance@0.2.0-alpha.8`, the full 2026-07-28 RC server
