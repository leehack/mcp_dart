...
| Dart client -> Dart server | Legacy HTTP+SSE | MCP 2025-11-25 | [`test/client/sse_client_test.dart`](../test/client/sse_client_test.dart), [`example/server_sse.dart`](../example/server_sse.dart), [`example/client_sse.dart`](../example/client_sse.dart) | Verified in source | Covers endpoint discovery, same-origin POST routing, initialization, tool listing, tool execution, and clean shutdown. HTTP+SSE is deprecated; use Streamable HTTP for new integrations. |
