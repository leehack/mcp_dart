...
- The official conformance package is still alpha. The 2026 client suite keeps
  `json-schema-ref-no-deref` expected-failed because the alpha.7 mock server for
